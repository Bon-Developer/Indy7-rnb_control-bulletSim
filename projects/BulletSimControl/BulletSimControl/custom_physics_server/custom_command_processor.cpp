#include "custom_command_processor.h"
#include "CommonInterfaces/CommonRenderInterface.h"
#include "SharedMemory/plugins/b3PluginCollisionInterface.h"
...
//#include "tiny_obj_loader.h" //2025.06.10 add

#include "../control_hub_plugin/ControlHubPlugin.h"

#ifndef SKIP_COLLISION_FILTER_PLUGIN
#include "SharedMemory/plugins/collisionFilterPlugin/collisionFilterPlugin.h"
#endif

#ifdef ENABLE_STATIC_GRPC_PLUGIN
#include "SharedMemory/plugins/grpcPlugin/grpcPlugin.h"
#endif  //ENABLE_STATIC_GRPC_PLUGIN

#ifndef SKIP_STATIC_PD_CONTROL_PLUGIN
#include "SharedMemory/plugins/pdControlPlugin/pdControlPlugin.h"
#endif  //SKIP_STATIC_PD_CONTROL_PLUGIN

#ifdef STATIC_LINK_SPD_PLUGIN
#include "SharedMemory/plugins/stablePDPlugin/BulletConversion.h"
#include "SharedMemory/plugins/stablePDPlugin/RBDModel.h"
#include "SharedMemory/plugins/stablePDPlugin/RBDUtil.h"
#endif

#ifdef STATIC_LINK_VR_PLUGIN
#include "SharedMemory/plugins/vrSyncPlugin/vrSyncPlugin.h"
#endif
...
#include "SharedMemory/plugins/tinyRendererPlugin/tinyRendererPlugin.h"
#endif

#ifdef B3_ENABLE_FILEIO_PLUGIN
#include "SharedMemory/plugins/fileIOPlugin/fileIOPlugin.h"
...
#include "SharedMemory/SharedMemoryUserData.h"
...
struct PhysicsServerCommandProcessorInternalData
{
	...
	{
		{
			b3PluginFunctions funcs(initPlugin_ControlHub, exitPlugin_ControlHub, executePluginCommand_ControlHub);
			funcs.m_preTickFunc = preTickPluginCallback_ControlHub;
			m_ControlHubPlugin = m_pluginManager.registerStaticLinkedPlugin("ControlHubPlugin", funcs);
		}
		{
